 ...
 * Class Autoloader
 *
 * @package WooDeliveryTime/Autoloader
 * @since   1.0
 */
...
class AutoLoader
{
	...
	public function __construct() {
        ...
        $this->include_path = untrailingslashit( plugin_dir_path( DWEB_DELIVERY_TIME_PLUGIN_FILE ) ) . '/includes/';
	...
	protected function get_file_name_from_class( $class ) {
        $prefix = 'Dornaweb\\WooDeliveryTime\\';
